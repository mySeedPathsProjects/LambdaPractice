...
namespace LambdaPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<string> kayakProducts = products.Where(x => x.ToLower().Contains("kayak")).ToList();
            ...
            List<string> shoeProducts = products.Where(x => x.ToLower().Contains("shoes")).ToList();
            ...
            foreach (string items in products.OrderByDescending(x => x.Length).ToList())
            {
                Console.WriteLine(items);
            }
